  ...
  Future<void> _onSignup() async {
    ...
    try {
      await AuthService.signUp(
        ...
        displayName: nameController.text.trim().isEmpty ? 'User' : nameController.text.trim(),
      );
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Expanded(
                              child: Text("I agree to the processing of Personal data", style: TextStyle(fontSize: 12)),
                            )
                          ],
                        ),
                        const SizedBox(height: 10),
                        _loading ? const CircularProgressIndicator() : CustomButton(text: "Sign up", onPressed: _onSignup),
