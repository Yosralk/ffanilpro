                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        _loading ? const CircularProgressIndicator() : CustomButton(text: "Sign in", onPressed: _onSignin),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: const Text("Sign up", style: TextStyle(color: kPrimary, fontWeight: FontWeight.bold)),
                            ),
                          ],
                        ),
                      ],
